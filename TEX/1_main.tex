...
\input{TEX/2_abstract.tex}\\
\textbf{Index Items:}
\newpage
\input{TEX/3_1_introduction.tex}
\input{TEX/3_modeling.tex}
\input{TEX/4_1_solution_copd.tex}
\input{TEX/4_2_solution_sc.tex}
\input{TEX/4_3solution_filter.tex}
\input{TEX/5_design_guide.tex}
